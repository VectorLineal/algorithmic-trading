...
TOTAL_POSITIONS = 10
MIN_NET_EXPOSURE = -0.012
MAX_NET_EXPOSURE = 0.012
MIN_NET_GROUP_EXPOSURE = -0.02
MAX_NET_GROUP_EXPOSURE = 0.02
...
MAX_SHORT_POSITION_SIZE = 0.5 / TOTAL_POSITIONS
MAX_LONG_POSITION_SIZE = 0.5 / TOTAL_POSITIONS


def initialize(context):
    context.msft = sid(5061)
    context.amzn = sid(16841)
    context.sne = sid(6984)
    ...
    algo.schedule_function(func=rebalance,
                           date_rule=algo.date_rules.week_start(days_offset=2),
...
def rebalance(context, data):
    ...
    constraints.append(
        opt.NetExposure(
            min=MIN_NET_EXPOSURE,
            max=MAX_NET_EXPOSURE
        ))
    
    labels = {context.msft: 'TECH', context.amzn: 'TECH', context.sne: 'TECH'}
    
    constraints.append(
        opt.NetGroupExposure.with_equal_bounds(
            labels = labels,
            min=MIN_NET_GROUP_EXPOSURE,
            max=MAX_NET_GROUP_EXPOSURE
        ))
